...
from anl.anl2024.negotiators import Conceder, Boulware, RVFitter, NaiveTitForTat
from anl.anl2024 import anl2024_tournament
from anl_agents.anl2024.takafam.shochan import Shochan, Shochan_base50, Shochan_base100
# from shochan_v2 import ShochanV2, Shochan_base50_v2
from negmas.tournaments import tournaments

if __name__ == "__main__":
    results = anl2024_tournament(
        n_scenarios=1, n_repetitions=1, nologs=True, njobs=-1,
        competitors=[Shochan, Conceder, Boulware ])
